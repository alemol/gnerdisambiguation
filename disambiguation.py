...
def read_file_as_json(filename):
	try:
		...
		sys.exit('problem reading: ' + filename)
...
def load_entities(filename):
	...
	for entity in list_entity:
		factList=facts_generator(entity)
		#print("factList",factList)
		#print("entity",entity)
		clip_s(factList)
	
def facts_generator(nameEntity):
	factList = []
...
def main():
	#filename = sys.argv[1]
	#filename = 'elgrafico8.json'
	filename = 'test/test8.json'
	f = load_entities(filename)
	print(f)
